...
const { LUA_MULTRET, to_luastring } = require('./defs.js');
const {
    BinOpr: {
        OPR_ADD,
        OPR_AND,
    ...
    UnOpr: { OPR_BNOT, OPR_LEN, OPR_MINUS, OPR_NOT, OPR_NOUNOPR },
    NO_JUMP,
    getinstruction,
    luaK_checkstack,
    luaK_codeABC,
...
const { LUAI_MAXCCALLS, MAX_INT, lua_assert } = require('./llimits.js');
...
const { luaS_eqlngstr, luaS_new, luaS_newliteral } = require('./lstring.js');
