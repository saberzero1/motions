...
const {
    ...
    LUA_MULTRET,
    LUA_SIGNATURE,
    constant_types: { LUA_TCCL, LUA_TLCF, LUA_TLCL, LUA_TNIL },
    thread_status: {
        LUA_ERRMEM,
        LUA_ERRERR,
        LUA_ERRRUN,
...
const { api_check, lua_assert, LUAI_MAXCCALLS } = require('./llimits.js');
...
const callhook = function (L, ci) {
    ...
    if (
        ...
        ci.previous.l_code[ci.previous.l_savedpc - 1].opcode ==
            lopcodes.OpCodesI.OP_TAILCALL
    ) {
