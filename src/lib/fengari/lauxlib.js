...
const { LUAL_BUFFERSIZE } = require('./luaconf.js');
const {
    LUA_ERRERR,
    LUA_MULTRET,
    LUA_REGISTRYINDEX,
...
const { requireModule } = require('./platform.js');
...
const pushfuncname = function (L, ar) {
    ...
    else if (ar.what && ar.what[0] === 109 /* 'm'.charCodeAt(0) */)
        /* main? */
        lua_pushliteral(L, 'main chunk');
    else if (ar.what && ar.what[0] === 76 /* 'L'.charCodeAt(0) */)
