...
const { lua_assert, luai_nummod } = require('./llimits.js');
const lobject = require('./lobject.js');
const lfunc = require('./lfunc.js');
const lstate = require('./lstate.js');
const { luaS_bless, luaS_eqlngstr, luaS_hashlongstr } = require('./lstring.js');
        ...
        switch (opcode) {
            ...
            case OP_TAILCALL: {
                ...
                if (ldo.luaD_precall(L, ra, LUA_MULTRET)) {
                    ...
                    lua_assert(
                        L.top ===
                            oci.l_base + L.stack[ofuncOff].value.p.maxstacksize,
                    );
