...
const {
    constant_types: { LUA_TTABLE, LUA_TUSERDATA },
    to_luastring,
} = require('./defs.js');
...
const { luaS_bless, luaS_new } = require('./lstring.js');
...
const luaT_init = function (L) {
    ...
    L.l_G.tmname[TMS.TM_NEWINDEX] = new luaS_new(
        L,
    ...
    L.l_G.tmname[TMS.TM_CONCAT] = new luaS_new(
        L,
        to_luastring('__concat', true),
    );
