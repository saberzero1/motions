...
| Table navigation               | toggle   | `true`   | —                           | `vim.opt.tablenav`              | `set tablenav`              | Enable table-nav overlay mode, cross-cell motions, and table motions (`]\| `, `[\| `, `]c`, `[c`). When disabled, Obsidian's native table cell editor handles cell boundary navigation directly.                                                               |
