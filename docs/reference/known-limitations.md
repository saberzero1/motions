...
description: Known limitations, architectural constraints, and intentional design decisions in Vim Motions.
tags:
    - reference
    - limitations
    - troubleshooting
...
| Reading view navigation         | Use the [vim-keynav](https://github.com/guoang/obsidian-vim-keynav) plugin                       |
