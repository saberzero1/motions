...
**Status**: Milestone 4b Batch 5 active-editor text, key delegation, frontmatter handling, decorations and fold mirroring, workspace/navigation, picker, Harpoon, marks-command, cross-note jumplist bridging, native Oil isolation, and Neovim-backed undo-tree sidebar implemented on desktop.
