...
The full e2e suite (`npm run test:e2e`) runs 79 spec files and takes approximately **20 minutes**. Each spec launches a fresh Obsidian instance. When running from an agent or script:
