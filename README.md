...
- **Table editing** — cell navigation, text objects, manipulation commands, format-on-exit auto-alignment, and native table editor integration with vim-enabled per-cell editing and direct table manipulation (`o`, `dd`, `J`/`K`, `H`/`L`, `=`)
